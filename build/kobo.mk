...
$(TARGET_OUTPUT_DIR)/KoboRoot.tgz: $(XCSOAR_BIN) \
	...
	$(Q)if test -f $(KOBO_KERNEL_DIR)/uImage.aura2v2; then install -m 0644 $(KOBO_KERNEL_DIR)/uImage.aura2v2 $(@D)/KoboRoot/opt/xcsoar/lib/kernel; fi
	$(Q)if test -f $(KOBO_KERNEL_DIR)/uImage.aura2v2.otg; then install -m 0644 $(KOBO_KERNEL_DIR)/uImage.aura2v2.otg $(@D)/KoboRoot/opt/xcsoar/lib/kernel; fi
